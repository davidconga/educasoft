...
class Pagamento extends Model {
    protected $fillable = ["aluno_id","plano_id","propina_id","emolumento_id","multa_id","bolsa_id","bolsa_financiador_id","recibo_bolsa_id","referencia","lote_id","valor","multa_valor","bolsa_valor","valor_carteira","valor_entregue","tipo","mes_referencia","metodo","num_referencia_externa","status","data_vencimento","data_pagamento","observacao","comprovativo","hash_factura","assinatura","hash_anterior","assinada_em","vendus_document_id","vendus_numero","vendus_hash","vendus_serie","vendus_pdf_url","vendus_emitido_em","vendus_erro","vendus_nc_document_id","vendus_nc_numero","vendus_nc_hash","vendus_nc_pdf_url","vendus_nc_emitido_em","vendus_nc_motivo","vendus_nc_erro","caixa_sessao_id","n_impressoes","originado_offline","lote_offline_ref","sincronizado_em"];
    protected $casts = ["valor"=>"float","multa_valor"=>"float","bolsa_valor"=>"float","valor_carteira"=>"float","valor_entregue"=>"float","data_vencimento"=>"date","data_pagamento"=>"date","vendus_emitido_em"=>"datetime","vendus_nc_emitido_em"=>"datetime","originado_offline"=>"bool","sincronizado_em"=>"datetime"];
