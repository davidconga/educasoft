...
class Aluno extends Model {
    protected $fillable = ["user_id","numero_aluno","data_nascimento","genero","naturalidade","nacionalidade","bi","nome_pai","nome_mae","telefone_responsavel","email_responsavel","endereco","foto","dados_academicos_verificados_em"];
    protected $casts = ["dados_academicos_verificados_em" => "datetime"];
